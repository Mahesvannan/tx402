#!/usr/bin/env node
/**
 * Minimal MCP wrapper for tx402.
 *
 * By default this wrapper is read-only against the public API. If /explain
 * returns a 402 challenge, the tool returns the payment requirements instead
 * of spending funds.
 *
 * To allow the MCP wrapper to pay from a local wallet, set:
 *   TX402_MCP_ENABLE_PAYMENTS=1
